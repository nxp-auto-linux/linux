 ...
 * revision of the SoC.
 */
static const u32 rev2_calib_scfgr[] = {
	0x2C, 0x59, 0xC6, 0x167
};

static const u32 rev2_calib_trcr[] = {
...
static void get_calib_with_fuses(struct device *dev, u32 *calib_scfgr,
				 u32 *calib_trcr, const u32 *calib_scfgr_base,
				 const u32 *calib_trcr_base, const u32 *warm_idxes,
				 const u32 *cold_idxes, size_t warm_size,
				 size_t cold_size, size_t table_size)
{
	size_t i;
...
static void get_calib_table(struct device *dev,
			    u32 *calib_scfgr, u32 *calib_trcr)
{
	static const u32 warm_idxes[] = {3};
	static const u32 cold_idxes[] = {0};

	get_calib_with_fuses(dev, calib_scfgr, calib_trcr,

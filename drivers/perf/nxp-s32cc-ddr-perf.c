...
static struct attribute *ddr_perf_events_attrs[] = {
	...
	S32CC_DDR_PMU_EVENT_ATTR(write-credit-cnt, 0x12),
	S32CC_DDR_PMU_EVENT_ATTR(read-command, 0x20),
	S32CC_DDR_PMU_EVENT_ATTR(write-command, 0x21),
	S32CC_DDR_PMU_EVENT_ATTR(read-modify-write-command, 0x22),
	S32CC_DDR_PMU_EVENT_ATTR(hp-read, 0x23),
	S32CC_DDR_PMU_EVENT_ATTR(hp-req-nocredit, 0x24),
	S32CC_DDR_PMU_EVENT_ATTR(hp-xact-credit, 0x25),
	S32CC_DDR_PMU_EVENT_ATTR(lp-req-nocredit, 0x26),
	S32CC_DDR_PMU_EVENT_ATTR(lp-xact-credit, 0x27),
	S32CC_DDR_PMU_EVENT_ATTR(wr-xact-credit, 0x29),
	S32CC_DDR_PMU_EVENT_ATTR(read-cycles, 0x2a),
	S32CC_DDR_PMU_EVENT_ATTR(write-cycles, 0x2b),
	S32CC_DDR_PMU_EVENT_ATTR(read-write-transition, 0x30),
	S32CC_DDR_PMU_EVENT_ATTR(precharge, 0x31),
	S32CC_DDR_PMU_EVENT_ATTR(activate, 0x32),
	S32CC_DDR_PMU_EVENT_ATTR(load-mode, 0x33),
	S32CC_DDR_PMU_EVENT_ATTR(perf-mwr, 0x34),
	S32CC_DDR_PMU_EVENT_ATTR(read, 0x35),
	S32CC_DDR_PMU_EVENT_ATTR(read-activate, 0x36),

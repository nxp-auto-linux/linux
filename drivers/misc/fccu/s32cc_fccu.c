...
static int __init fccu_probe(struct platform_device *pdev)
{
...
static int __exit fccu_remove(struct platform_device *pdev)
{
	struct fccu_pri_data *priv_data = NULL;
...
module_platform_driver_probe(fccu_driver, fccu_probe);
